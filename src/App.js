...
const models = [
  {
    ...
    category: 'Gen AI',
    url: process.env.NODE_ENV === 'production' ? 'https://ai-modelhub.onrender.com/dist/gen-ai/StoryTeller.html' : '/gen-ai/StoryTeller.html'
  },
  {
    id: 2,
    name: 'DietPlanner',
    ...
    category: 'Gen AI',
    url: process.env.NODE_ENV === 'production' ? 'https://ai-modelhub.onrender.com/dist/gen-ai/DietPlanner.html' : '/gen-ai/DietPlanner.html'
  },
  {
    id: 3,
